...
public class App {
	 ...
	 * @throws InvalidOffsetException 
		...
		private static void executeDocument(StanfordCoreNLP pipeline, File inputFile, File outputGATEFile) throws ResourceInstantiationException, MalformedURLException, InvalidOffsetException {
			...
			String text2 = "On completion of treatment all animals were sacrificed under general KetavetÂ® anesthesia by exsanguination via the left and right femoral blood vessels.";
