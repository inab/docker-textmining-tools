...
public class App {
	...
	private static void processDocument(File inputFile, File outputGATEFile) throws ResourceInstantiationException, JsonGenerationException, IOException{
		...
		String annotationSet = "TREATMENT_RELATED_FINDINGS_JAVA";
		for (Annotation finding : findings.inDocumentOrder()){
			//Integer id = FINDING_COUNTER.next();
		  	...
		  	for (Annotation sentence : sentences){
				...
				doc.getAnnotations(annotationSet).add(finding.getStartNode(), finding.getEndNode(), "FINDING_"+finding_id, finding.getFeatures());
				...
				doc.getAnnotations(annotationSet).add(sentence.getStartNode(), sentence.getEndNode(), "FINDING_"+finding_id, sentence.getFeatures());
				...
				if(ann!=null) {
					...
					doc.getAnnotations(annotationSet).add(ann.getStartNode(), ann.getEndNode(), "FINDING_"+finding_id, ann.getFeatures());
				}else {
					...
					doc.getAnnotations(annotationSet).add(sentence.getStartNode(), sentence.getEndNode(), "FINDING_"+finding_id, features_uncertain);
				}
				...
				if(specimen!=null) {
					...
					doc.getAnnotations(annotationSet).add(specimen.getStartNode(), specimen.getEndNode(), "FINDING_"+finding_id, specimen.getFeatures());
				}
				...
				if(STUDY_TESTCD!=null) {
					...
					doc.getAnnotations(annotationSet).add(STUDY_TESTCD.getStartNode(), STUDY_TESTCD.getEndNode(), "FINDING_"+finding_id, STUDY_TESTCD.getFeatures());
				}
				...
				if(STUDY_DOMAIN!=null) {
					...
					doc.getAnnotations(annotationSet).add(STUDY_DOMAIN.getStartNode(), STUDY_DOMAIN.getEndNode(), "FINDING_"+finding_id, STUDY_DOMAIN.getFeatures());
				}
				
				Annotation sex = getClosestAnnotation(doc,  sentenceFields, finding, "SEX");
				if(sex!=null) {
					System.out.println("SEX: " + gate.Utils.stringFor(doc, sex));
					sex.getFeatures().put(template_value_name, getSendCode(sex, gate.Utils.stringFor(doc, sex)));
					sex.getFeatures().put("ANNOTATION_TYPE",sex.getType());
					doc.getAnnotations(annotationSet).add(sex.getStartNode(), sex.getEndNode(), "FINDING_"+finding_id, sex.getFeatures());
				}
				...
				if(group!=null) {
					...
					doc.getAnnotations(annotationSet).add(group.getStartNode(), group.getEndNode(), "FINDING_"+finding_id, group.getFeatures());
				}
				...
				if(risk_level!=null) {
					...
					doc.getAnnotations(annotationSet).add(risk_level.getStartNode(), risk_level.getEndNode(), "FINDING_"+finding_id, risk_level.getFeatures());
				}
				...
				if(DOSE_QUANTITY!=null) {
					...
					doc.getAnnotations(annotationSet).add(DOSE_QUANTITY.getStartNode(), DOSE_QUANTITY.getEndNode(), "FINDING_"+finding_id, DOSE_QUANTITY.getFeatures());
				}
				...
				if(DOSE_FREQUENCY!=null) {
					...
					doc.getAnnotations(annotationSet).add(DOSE_FREQUENCY.getStartNode(), DOSE_FREQUENCY.getEndNode(), "FINDING_"+finding_id, DOSE_FREQUENCY.getFeatures());
				}
				...
				if(DOSE_DURATION!=null) {
					...
					doc.getAnnotations(annotationSet).add(DOSE_DURATION.getStartNode(), DOSE_DURATION.getEndNode(), "FINDING_"+finding_id, DOSE_DURATION.getFeatures());
				}
				...
				if(STUDY_DAY_FINDING!=null) {
					...
					doc.getAnnotations(annotationSet).add(STUDY_DAY_FINDING.getStartNode(), STUDY_DAY_FINDING.getEndNode(), "FINDING_"+finding_id, STUDY_DAY_FINDING.getFeatures());
				}
				...
				if(ROUTE_OF_ADMINISTRATION!=null) {
					...
					doc.getAnnotations(annotationSet).add(ROUTE_OF_ADMINISTRATION.getStartNode(), ROUTE_OF_ADMINISTRATION.getEndNode(), "FINDING_"+finding_id, ROUTE_OF_ADMINISTRATION.getFeatures());
				}
				...
				if(MODE_OF_ACTION!=null) {
					...
					doc.getAnnotations(annotationSet).add(MODE_OF_ACTION.getStartNode(), MODE_OF_ACTION.getEndNode(), "FINDING_"+finding_id, MODE_OF_ACTION.getFeatures());
				}
				...
				if(CYPS!=null) {
					...
					doc.getAnnotations(annotationSet).add(CYPS.getStartNode(), CYPS.getEndNode(), "FINDING_"+finding_id, CYPS.getFeatures());
				}
